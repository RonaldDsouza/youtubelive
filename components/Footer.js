...
const Footer = () => (
  <footer style={{ padding: '20px', backgroundColor: '#000', color: '#fff', textAlign: 'center' }}>
    ...
    <p className="text-black hover:px-0 text-bg font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent mt-2 text-center text-sm" >© 2024 Youtube Live™ - All Rights Reserved</p>
    {/* <nav>
