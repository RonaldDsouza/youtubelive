...
export async function getStaticProps() {
  try {
    const res = await fetch("https://youtubelive.vercel.app/fashion.json");
    if (!res.ok) {
...
export default function HomePage({ articles }) {
  ...
  const fashionSchema = JSON.stringify({
    ...
    "@graph": [
      {
        ...
        "image": { "@id": "https://youtubelive.vercel.app/fashion/#primaryimage" },
        "thumbnailUrl": "https://youtubelive.vercel.app/og_image.jpg",
        "breadcrumb": { "@id": "https://youtubelive.vercel.app/fashion/#breadcrumb" },
        "inLanguage": "en-US"
      },
      {
        "@type": "ImageObject",
        "inLanguage": "en-US",
        "@id": "https://youtubelive.vercel.app/fashion/#primaryimage",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://youtubelive.vercel.app/fashion/#breadcrumb",
        "itemListElement": [
  ...
  return (
    <>
      <Head>
        <title>Youtube Live™ - Fashion & Beauty Section.</title>
        ...
        />
        <link rel="canonical" href="https://youtubelive.vercel.app/fashion" />
        <meta
        ...
        <meta
          property="og:title"
          content="Youtube Live™ - Fashion & Beauty Section."
        />
        <meta property="og:url" content="https://youtubelive.vercel.app/fashion" />
        <meta
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: fashionSchema }}
        />
      ...
      <header className={youtubeStyles.header}>
        <h1 className={youtubeStyles.logo}>Fashion & Beauty Section.</h1>
      </header>
