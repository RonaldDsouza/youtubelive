...
export default function HomePage({ articles }) {
  ...
  const uwatchfreeSchema = JSON.stringify([
    {
      ...
      "@type": "Organization",
      name: "Youtube Live™ - Education & Courses Section.",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://youtubelive.vercel.app/education#webpage",
  ...
  return (
    <>
      <Head>
        <title>Youtube Live™ - Education & Courses Section.</title>
        ...
        />
        <link rel="canonical" href="https://youtubelive.vercel.app/education" />
        <meta
