...
export async function getServerSideProps() {
  const res = await fetch("https://youtubelive.vercel.app/music.json");
...
export default function HomePage({ articles }) {
  ...
  const uwatchfreeSchema = JSON.stringify([
    {
      ...
      "@type": "Organization",
      name: "Youtube Live™ - Music Section.",
  ...
  const rankMathSchema = JSON.stringify({
    ...
    "@graph": [
      ...
      {
        "@type": "WebPage",
        "@id": "https://youtubelive.vercel.app/music#webpage",
  ...
  return (
    <>
      <Head>
        <title>Youtube Live™ - Music Section.</title>
        ...
        />
        <link rel="canonical" href="https://youtubelive.vercel.app/music" />
        <meta
        ...
        <meta property="og:title" content="Youtube Live™ - Music Section." />
        <meta property="og:url" content="https://youtubelive.vercel.app/music" />
        <meta
          property="og:site_name"
          content="Youtube Live™ - Music Section."
        />
        <meta
          property="og:image"
        ...
        <meta name="twitter:title" content="Youtube Live™ - Music Section." />
        <meta
      ...
      <header className={youtubeStyles.header}>
        <h1 className={youtubeStyles.logo}>Music Section.</h1>
      </header>
