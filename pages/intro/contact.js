...
const contact = () => {
  ...
  return (
    <div>
      <Head>
        <title>Youtube Live™ - Online. Stream. Discover. | Contact Us</title>
        ...
        <link rel="canonical" href="https://youtubelive.vercel.app/intro/contact" />
        ...
        <meta
          property="og:url"
          content="https://youtubelive.vercel.app/intro/contact/"
        />
        <meta
          ...
          <div className="flex flex-wrap">
            <div className="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
              ...
              <p className="text-gray-500 mb-6">
                ...
                related to Youtube Live™ - Online. Stream. Discover.. We welcome
                your input to help us echance our services and offerings.
              </p>
