...
export async function getStaticProps() {
  try {
    const res = await fetch("https://youtubelive.vercel.app/technology.json");
    if (!res.ok) {
...
export default function HomePage({ articles }) {
  ...
  const technologySchema = JSON.stringify({
    ...
    "@graph": [
      {
        ...
        "image": { "@id": "https://youtubelive.vercel.app/technology/#primaryimage" },
        "thumbnailUrl": "https://youtubelive.vercel.app/og_image.jpg",
        "breadcrumb": { "@id": "https://youtubelive.vercel.app/technology/#breadcrumb" },
        "inLanguage": "en-US"
      },
      {
        "@type": "ImageObject",
        "inLanguage": "en-US",
        "@id": "https://youtubelive.vercel.app/technology/#primaryimage",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://youtubelive.vercel.app/technology/#breadcrumb",
        "itemListElement": [
  ...
  return (
    <>
      <Head>
        <title>Youtube Live™ - Science & Technology Section.</title>
        ...
        <link
          rel="canonical"
          href="https://youtubelive.vercel.app/technology"
        />
        <meta
        ...
        <meta
          property="og:title"
          content="Youtube Live™ - Science & Technology Section."
        />
        <meta
          property="og:url"
          content="https://youtubelive.vercel.app/technology"
        />
        <meta
        ...
        <script
          ...
          dangerouslySetInnerHTML={{ __html: technologySchema }}
        />
        <script
          async
      ...
      <header className={youtubeStyles.header}>
        <h1 className={youtubeStyles.logo}>Science & Technology Section.</h1>
      </header>
