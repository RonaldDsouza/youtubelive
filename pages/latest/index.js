...
export async function getServerSideProps() {
  const res = await fetch("https://youtubelive.vercel.app/latest.json");
...
export default function HomePage({ articles }) {
  ...
  return (
    <>
      <Head>
        <title>Youtube Live™ - Trending & Latest Section.</title>
        ...
        />
        <link rel="canonical" href="https://youtubelive.vercel.app/latest" />
        <meta
        ...
        <meta
          property="og:title"
          content="Youtube Live™ - Trending & Latest Section."
        />
        <meta property="og:url" content="https://youtubelive.vercel.app/latest" />
        <meta
      ...
      <header className={youtubeStyles.header}>
        <h1 className={youtubeStyles.logo}>Trending & Latest Section.</h1>
      </header>
