...
export default function HomePage({ articles }) {
  ...
  const loadDailymotionPlayer = (videoId) => {
    ...
    const player = document.createElement("iframe");
    player.src = `https://www.dailymotion.com/embed/video/${videoId}?autoplay=1`;
    player.width = "100%";
    player.height = "100%";
    player.setAttribute("allowfullscreen", "true");
    player.setAttribute("frameborder", "0");
  ...
  return (
    <>
      <Head>
        <title>Youtube Live™ - Movie Trailers Section.</title>
        ...
        />
        <link rel="canonical" href="https://youtubelive.vercel.app/trailers" />
        <meta
